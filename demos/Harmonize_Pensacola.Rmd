...
conda_create("~opt/anaconda3/envs/wq-reticulate")

conda_install("~opt/anaconda3/envs/wq-reticulate", "geopandas")
conda_install("~opt/anaconda3/envs/wq-reticulate", "pint")

#not sure if this is needed
conda_install("~opt/anaconda3/envs/wq-reticulate", "r-rmarkdown")

#may need to switch to use R version of dataRetrieval
conda_install("~opt/anaconda3/envs/wq-reticulate", "dataretrieval")
...
py_install("git+https://github.com/USEPA/harmonize-wq.git", pip = TRUE, envname = "~opt/anaconda3/envs/wq-reticulate")
