...
##Note: changed conda location to:
#options(reticulate.conda_binary = "C:\\Users\\cmulli01\\Anaconda3\\Scripts\\conda.exe")
...
#conda_install("wq-reticulate", "r-rmarkdown")

#may need to switch to use R version of dataRetrieval
...
py_install("git+https://github.com/USEPA/harmonize-wq.git", pip = TRUE, envname = "C:\Users\cmulli01\AppData\Local\R-MINI~1\envs\wq-reticulate")

use_condaenv("~opt/anaconda3/envs/wq-reticulate")

# use these for testing, but then can remove
import("harmonize_wq")
...
```{python}
conda_python(envpath, "~opt/anaconda3/envs/wq-reticulate")
...
## Steps Cristina needed
Once miniforge is installed. Go to your start menu and open the Miniforge Prompt
Then complete steps above from Marc
