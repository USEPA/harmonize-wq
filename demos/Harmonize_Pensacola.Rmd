...
An installation of Conda is required to run EPA's harmonize-wq package
using R/reticulate.

There are multiple installers available for Conda (see:
<https://conda.io/projects/conda/en/latest/user-guide/install/index.html>).

One example installer is
[miniforge](https://github.com/conda-forge/miniforge). We use miniforge3
in these examples.
...
However, you may still need to specify the conda.exe location.
To do so, update the code below to specify your conda.exe location
...
```{r, results = 'hide'}
reticulate::conda_install("wq_harmonize", "geopandas")
reticulate::conda_install("wq_harmonize", "pint")
reticulate::conda_install("wq_harmonize", "dataretrieval")
```
